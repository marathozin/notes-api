...
class NoteService:
    @staticmethod
    def create_note(db: Session, current_user: models.User, note: NoteCreate) -> models.User:
        """Создание заметки"""
        # Создание заметки
        db_note = models.Note(
            title=note.title,
    ...
    def get_note(db: Session, current_user: models.User, note_id: int):
        ...
        note = db.execute(select(models.Note).where(
    ...
    @staticmethod
    def update_note(db: Session, current_user: models.User, note_id: int, note_update: NoteUpdate):
        """Обновить заметку"""
        note = db.execute(select(models.Note).where(
            models.Note.id == note_id,
            models.Note.user_id == current_user.id
    ...
    @staticmethod
    def add_tag_to_note(db: Session, current_user: models.User, note_id: int, tag_id: int):
    ...
    @staticmethod
    def remove_tag_from_note(db: Session, current_user: models.User, note_id: int, tag_id: int):
